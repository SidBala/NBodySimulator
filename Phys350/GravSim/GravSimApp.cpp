...
CGravSimApp::CGravSimApp()
{
	...
	m_mouseMoved = false;						// reset mouse status
	m_mouseLeftUp = false;
...
CGravSimApp theApp;	//global app-object (also defined in stdafx.h)
...
BOOL CGravSimApp::CreateOpenGLWindow()
{
...
void CGravSimApp::DestroyOpenGLWindow()								// Destroy The OpenGL Window & Release Resources
{
...
BOOL CGravSimApp::RegisterWindowClass()
{
...
BOOL CGravSimApp::ChangeScreenResolution (int width, int height, int bitsPerPixel)	// Change The Screen Resolution
{
...
void CGravSimApp::ReshapeGL(int width, int height)						// Reshape The Window When It's Moved Or Resized
{
	m_Width = width;													// Update height and width
	m_Height = height;
